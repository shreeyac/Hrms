...
<div class="wrapper">
	...
	<%@include file="userHeader.jsp" %>
	 <span style="font-size:20px;padding:10px;color:white">Click the button to view Leave information</span><button onclick="validate.getUserLeave()">Click Here</button>
	<input type="hidden" name="<%=contextPath%>" value="<%=contextPath%>" id="contextPath">
	<input type="hidden" name="empid" value="<%=pkempid%>" id="empid">
	<div id="showUserLeave" style="text-align:center ; color:white"></div>
	</div>
